...
var RestSpotApi = function (_RestCommonApi) {
    ...
    _createClass(RestSpotApi, [{
        ...
        key: 'ledger',
        value: async function ledger(from, to, limit) {
        ...
        key: 'postOrders',
        value: async function postOrders(client_oid, type, side, instrument_id, margin_trading, price, size, notional) {

            return await (0, _httpPost2.default)(this.url + '/api/spot/v3/orders', {
        ...
        key: 'postBatch_orders',
        value: async function postBatch_orders(batch_orders) {
            return await (0, _httpPost2.default)(this.url + '/api/spot/v3/batch_orders', batch_orders, this.accessKey, this.passphrase, this.secretKey);
        }
        ...
        key: 'postCancel_orders',
        value: async function postCancel_orders(orderId, client_oid, instrument_id) {
            return await (0, _httpPost2.default)(this.url + '/api/spot/v3/cancel_orders/' + orderId, {
                client_oid: client_oid,
                instrument_id: instrument_id
            }, this.accessKey, this.passphrase, this.secretKey);
        }
        ...
        key: 'postCancel_batch_orders',
        value: async function postCancel_batch_orders(cancel_batch_orders) {
            return await (0, _httpPost2.default)(this.url + '/api/spot/v3/cancel_batch_orders/' + orderId, cancel_batch_orders, this.accessKey, this.passphrase, this.secretKey);
        }
        ...
        key: 'getOrders_pending',
        value: async function getOrders_pending(limit, instrument_id, from, to) {

            return await (0, _httpGet2.default)(this.url + '/api/spot/v3/orders_pending', {
                instrument_id: instrument_id,
                limit: limit,
                from: from,
                to: to
        ...
        key: 'geOrdersById',
        value: async function geOrdersById(order_id, instrument_id) {
        ...
        key: 'getFills',
        value: async function getFills(order_id, instrument_id, from, to, limit) {
            return await (0, _httpGet2.default)(this.url + '/api/spot/v3/fills', {
                order_id: order_id,
                instrument_id: instrument_id,
                from: from,
                to: to,
        ...
        key: 'getInstruments',
        value: async function getInstruments() {
            return await (0, _httpGet2.default)(this.url + '/api/spot/v3/instruments', {}, this.accessKey, this.passphrase, this.secretKey);
        }
        ...
        key: 'getInstrumentsBybook',
        value: async function getInstrumentsBybook(instrument_id, size, depth) {
            return await (0, _httpGet2.default)(this.url + '/api/spot/v3/instruments/' + instrument_id + '/book', {
                instrument_id: instrument_id,
                size: size,
                depth: depth
            }, this.accessKey, this.passphrase, this.secretKey);
        ...
        key: 'getInstrumentsTicker',
        value: async function getInstrumentsTicker() {
            return await (0, _httpGet2.default)(this.url + '/api/spot/v3/instruments/ticker', {}, this.accessKey, this.passphrase, this.secretKey);
        }
        ...
        key: 'getInstrumentsTickerById',
        value: async function getInstrumentsTickerById(instrument_id) {
            return await (0, _httpGet2.default)(this.url + '/api/spot/v3/instruments/' + instrument_id + '/ticker', {}, this.accessKey, this.passphrase, this.secretKey);
        }
        ...
        key: 'getInstrumentsTrades',
        value: async function getInstrumentsTrades(instrument_id, limit, from, to) {
            return await (0, _httpGet2.default)(this.url + '/api/spot/v3/instruments/' + instrument_id + '/trades', {
                limit: limit,
                from: from,
                to: to
            }, this.accessKey, this.passphrase, this.secretKey);
        ...
        key: 'getInstrumentsCandles',
        value: async function getInstrumentsCandles(instrument_id, granularity, start, end) {
            return await (0, _httpGet2.default)(this.url + '/api/spot/v3/instruments/' + instrument_id + '/candles', {
